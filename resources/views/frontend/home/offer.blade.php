                        ...
                        <div class="row align-items-center">
                           ...
                           <div class="col-xl-4 col-lg-6 col-md-6">
                              <div class="tp-price-button text-md-end">
                                 <a href="https://wp.aqlova.com/listbnb/contact/" target="_self" rel="nofollow" class="tp-btn-border tp-el-box-btn">Subscribe Now<i class="fa-sharp fa-regular fa-arrow-right-long"></i></a>
                              </div>
                           </div>
                        </div>
                     </div>

 <section class="feature-section padding-top padding-bottom bg_img" data-background="./assets/images/feature/feature-bg.png" id="feature">
            ...
            data-paroller-type="foreground" data-paroller-direction="horizontal">
                <img src="{{ asset('frontend/assets/images/balls/ball1.png') }}" alt="balls">
            </div>
            <div class="ball-2" data-paroller-factor="-0.30" data-paroller-factor-lg="0.60"
            data-paroller-type="foreground" data-paroller-direction="horizontal">
                <img src="{{ asset('frontend/assets/images/balls/ball2.png') }}" alt="balls">
            </div>
            <div class="ball-3" data-paroller-factor="0.30" data-paroller-factor-lg="-0.30"
            data-paroller-type="foreground" data-paroller-direction="horizontal">
                <img src="{{ asset('frontend/assets/images/balls/ball3.png') }}" alt="balls">
            </div>
            <div class="container">
                ...
                <div class="row justify-content-center feature-wrapper">
                    <div class="col-md-6 col-sm-10 col-lg-4">
                        <div class="feature-item">
                            <div class="feature-thumb">
                                <img src="{{ asset('frontend/assets/images/feature/feature01.png') }}" alt="feature">
                            </div>
                    ...
                    <div class="col-md-6 col-sm-10 col-lg-4">
                        <div class="feature-item">
                            <div class="feature-thumb">
                                <img src="{{ asset('frontend/assets/images/feature/feature02.png') }}" alt="feature">
                            </div>
                            <div class="feature-content">
                    ...
                    <div class="col-md-6 col-sm-10 col-lg-4">
                        <div class="feature-item">
                            <div class="feature-thumb">
                                <img src="{{ asset('frontend/assets/images/feature/feature03.png') }}" alt="feature">
                            </div>
                            <div class="feature-content">

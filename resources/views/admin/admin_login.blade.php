...
<div class="admin-auth">
    ...
    var notify = {
        ...
        <div class="login">
        <div class="side-img primary-overlay" style="
            background: url(https://hyiprio.tdevs.co/assets/global/images/bdVMA7Po89q8yjy8LIVh.jpg) no-repeat center center;">
            <div class="title">
                <h3>Admin Login</h3>
            </div>
        </div>
            ...
            <div class="auth-body">
					...
					<form class="row g-3" method="POST" action="{{ route('admin.authenticate') }}">
											 ...
											 <div class="single-box">
												<label for="inputEmailAddress" class="box-label">Email</label>
                    ...
                    <div class="single-box">
                        <label for="" class="box-label">Password</label>
                      <input type="password" name="password" class="box-input" id="password" placeholder="Enter Password"> 
                    </div>
                    <div class="single-box">
                        <button class="site-btn primary-btn" type="submit">Admin Login</button>
...
<div id="loom-companion-mv3" ext-id=""><div id="shadow-host-companion"></div></div></body></html>

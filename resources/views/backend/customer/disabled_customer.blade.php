...
<div class="main-content">
   <div class="page-title">
      <div class="container-fluid">
         <div class="row">
            <div class="col">
               <h2 class="title">All Disabled Customers</h2>
            </div>
         </div>
      </div>
   </div>
...
<tr>
    ...
    <td><a class="link" href="{{ route('admin.user.edit', $customer->id) }}">{{ $customer->name }}</a></td>
...
<td>${{ number_format($walletBalance, 2) }}</td>
    ...
    <td>
        <div class="site-badge {{ $customer->email_verified_at ? 'success' : 'pending' }}">

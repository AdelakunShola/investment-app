    ...
    <div class="table-filter d-flex justify-content-between">
        ...
        <div class="filter d-flex">
            ...
            <select class="form-select form-select-sm me-2" name="filter_by_transaction_type">
                ...
                <option value="investment" {{ request('filter_by_transaction_type') == 'investment' ? 'selected' : '' }}>Investment</option>
                <option value="withdraw" {{ request('filter_by_transaction_type') == 'withdraw' ? 'selected' : '' }}>Withdraw</option>
                <option value="deposit" {{ request('filter_by_transaction_type') == 'deposit' ? 'selected' : '' }}>Deposit</option>
                <option value="signup_bonus" {{ request('filter_by_transaction_type') == 'signup_bonus' ? 'selected' : '' }}>Signup Bonus</option>
            </select>
